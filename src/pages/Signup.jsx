        ...
        <>
            <div className="background">
                ...
                <div className="background_inner">
                    ...
                    <button className="button_new" onClick={() => navigate("/Home")}>Continue</button>
                    <div className="divider_new">
                        <div className="line_new"></div>
                        <div className="or_new">OR</div>
                        <div className="line_new"></div>
                    </div>
                    <button className="button_new_other" onClick={() => navigate("/Signup_with_code")}>Signup with one time code</button>
